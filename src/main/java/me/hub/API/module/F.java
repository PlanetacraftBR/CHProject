...
public class F
{
  ...
  public static String desc(String head, Object object)
  {
    return C.descHead + head + ": " + C.descBody + object;
  }
  ...
  public static String help(String cmd, String body)
  {

    return C.rAll + cmd + " " + C.mBody + body + " ";
  }
