...
import me.hub.effect.ReflectionUtils;
      ...
      try
      {
        ...
        else
        {
          ...
          if (this.data != null)
          {
            ...
            ReflectionUtils.setValue(this.packet, true, "k", new int[] { (int) (this.effect == Particles.ITEM_CRACK ? packetData : packetData[0] | packetData[1] << 12) });
          }
        }
