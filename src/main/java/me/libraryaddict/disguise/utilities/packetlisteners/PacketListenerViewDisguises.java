...
public class PacketListenerViewDisguises extends PacketAdapter
{
    ...
    public PacketListenerViewDisguises(Main libsDisguises2)
    {
        super(libsDisguises2, ListenerPriority.HIGH, Server.NAMED_ENTITY_SPAWN, Server.ATTACH_ENTITY, Server.REL_ENTITY_MOVE,
