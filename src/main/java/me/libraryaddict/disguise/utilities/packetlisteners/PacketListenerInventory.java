...
{
    private Main libsDisguises;

    public PacketListenerInventory(Main libsDisguises2)
    {
        super(libsDisguises2, ListenerPriority.HIGH, Server.SET_SLOT, Server.WINDOW_ITEMS, PacketType.Play.Client.HELD_ITEM_SLOT,
    ...
    public void onPacketReceiving(final PacketEvent event)
    {
        ...
        if (event.getPlayer() instanceof Factory || event.getPlayer().getVehicle() != null)
        {
            return;
        }
